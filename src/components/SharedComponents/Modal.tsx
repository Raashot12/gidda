  ...
  return (
    <div className="absolute top-0 left-0 w-full h-full z-50 md:w-[100%]">
      <div className="relative w-full flex flex-col h-full bg-white border  rounded shadow-lg">
        <>{headerComponent}</>
        <ScrollArea className="h-[70vh] px-[25px] md:px-[38px] flex-1">
          {children}
        </ScrollArea>
        <footer className="bg-[#F0F0F0] py-4 flex items-center justify-center">
          <div className="flex items-center gap-5">
            ...
            <button className="bg-[#346633] text-white px-4 py-3 rounded-[100px] flex items-center gap-2 text-[13px] font-[700] hover:bg-[#174319] transition">
              Create Estate
            </button>
          </div>
        </footer>
