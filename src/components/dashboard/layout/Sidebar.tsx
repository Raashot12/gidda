  ...
  return (
    <aside className={sidebarClasses}>
      ...
      <div className="mt-[43px] md:pl-[30px] md:pr-[30px] flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar">
        <div className="space-y-[25px] mt-[16px] text-[#0A0A0A]">
          <div
      ...
      <div className="md:pl-[30px] md:pr-[20px]">
        <CustomMenu>
          ...
          <CustomMenu.Dropdown direction="up" width="149" align="right">
            <CustomMenu.Item leftIcon={<IconProfile />}>
              <p className="font-[400] ml-1 text-[11px] text-[#4B4B4B]">
                My Profile
              </p>
            </CustomMenu.Item>
            ...
            >
              <p className="font-[700]  ml-1 text-[11px] text-[#E40000]">
                Logout
              </p>
            </CustomMenu.Item>
          </CustomMenu.Dropdown>
